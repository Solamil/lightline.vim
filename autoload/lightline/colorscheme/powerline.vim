...
let s:p.normal.left = [ ['darkestgreen', 'brightgreen', 'bold'], ['gray10', 'gray2'] ]
let s:p.normal.right = [ ['gray5', 'gray10'], ['gray9', 'gray4'], ['gray8', 'gray2'] ]
let s:p.inactive.right = [ ['gray1', 'gray5'], ['gray4', 'gray1'], ['gray4', 'gray0'] ]
let s:p.inactive.left = s:p.inactive.right[1:]
let s:p.insert.left = [ ['white', 'darkblue', 'bold'], ['white', 'gray2']]
" let s:p.insert.right = [ [ 'darkestcyan', 'mediumcyan' ], [ 'mediumcyan', 'darkblue' ], [ 'mediumcyan', 'darkestblue' ] ]
let s:p.replace.left = [ ['white', 'brightred', 'bold'], ['white', 'gray2'] ]
let s:p.visual.left = [ ['darkred', 'brightorange', 'bold'], ['white', 'gray2'] ]
